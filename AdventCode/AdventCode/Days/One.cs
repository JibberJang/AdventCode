...
namespace AdventCode.Days
{
    public class One
    {
        public void GetSolution()
        {
            ...
            {
                var matchingNumber = _numbers.FirstOrDefault(x => x + number == 2020);
            ...
            foreach (var number in _numbers)
            {
                ...
                foreach (var secondNumber in _numbers)
                {
                    var matchingNumber = _numbers.FirstOrDefault(x => x + secondNumber + number == 2020);
        ...
        private readonly IEnumerable<int> _numbers = new List<int>
        {
            1895,
1504,
1660,
